...
/**
 * UnionSet is the union of an array of SampledSets. They must match in domain
 * dimension, manifold dimension, CoordinateSystem, and Units. No sets in the
 * array can be null, and there must be at least one SampledSet in the array
 * (i.e. array.length != 0).
 * <P>
 */
public class UnionSet {// extends SampledSet {
	...
	// }
	//
	// public UnionSet(MathType type, SampledSet[] sets, CoordinateSystem
	// coord_sys,
	...
	//
	// /**
	// * Create a UnionSet that is the inverse cross product of this UnionSet
	// and
	// * the input SampledSet.
	// *
	// * @param set input SampledSet
	...
	// }
	//
	// public Set makeSpatial(SetType type, float[][] samples) throws
	// VisADException {
	// int n = Sets.length;
	...
	// System.out.println("m = " + m + " k = " + k + " sub_length = " +
	// sub_length +
