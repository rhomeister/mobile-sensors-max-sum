...
/**
 * This is a modified version of SVD, that behaves the same as the Matlab
 * implementation. The original SVD computes a economy version of SVD only. See
 * Matlab documentation for more details.
 */

public class SingularValueDecompositionFull implements java.io.Serializable {
	...
	public SingularValueDecompositionFull(Matrix Arg) {
